...
var Pool = /*#__PURE__*/function () {
  ...
  function () {
    var _getOutputAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(inputAmount, sqrtPriceLimitX96) {
      var zeroForOne, _yield$this$swap, outputAmount, sqrtRatioX96, liquidity, tickCurrent, remainingInputAmount, outputToken;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              remainingInputAmount = _yield$this$swap.amountSpecifiedRemaining;
              outputToken = zeroForOne ? this.token1 : this.token0;
              return _context.abrupt("return", [sdkCore.CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider), sdkCore.CurrencyAmount.fromRawAmount(inputAmount.currency, remainingInputAmount)]);
  ...
  function () {
    var _getInputAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(outputAmount, sqrtPriceLimitX96) {
      var zeroForOne, _yield$this$swap2, inputAmount, sqrtRatioX96, liquidity, tickCurrent, remainingOutputAmount, inputToken;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              remainingOutputAmount = _yield$this$swap2.amountSpecifiedRemaining;
              inputToken = zeroForOne ? this.token0 : this.token1;
              return _context2.abrupt("return", [sdkCore.CurrencyAmount.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, tickCurrent, this.tickDataProvider), sdkCore.CurrencyAmount.fromRawAmount(outputAmount.currency, JSBI.multiply(remainingOutputAmount, NEGATIVE_ONE))]);
